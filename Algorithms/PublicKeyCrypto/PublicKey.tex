...
Generate private and public keys using PyCrypto.
Share your public keys with everyone in the group.
Encrypt and sign a message for someone in the group and send it to the entire group.

\begin{enumerate}
\item Decrypt the message addressed for you.
\item Attempt to decrypt a message addressed for someone else in the group.
\item Verify that the message has been signed
\item Verify the signature.  Determine who sent the message.
\item Report the message
\end{enumerate}
\end{problem}
